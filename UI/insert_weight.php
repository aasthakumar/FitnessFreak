...
$q=$cn->exec("call prc_add_progress('".$uid."', '".$weight."',@out)");
...
<form name="weight_progress" method="GET">
	<input type="hidden" name="uid" value="<?php echo $uid; ?>"/>
	<button class="button button2" formaction="weight_progress.php">Weight Progress</button>
</body>
