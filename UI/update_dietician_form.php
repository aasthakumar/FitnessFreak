...
<body>
    ...
    ?>
<form name="frmRegistration" method="post" action="update_dietician.php">
<input type="hidden" name="uid" value="<?php echo $uid; ?>" />
<input type="hidden" name="dieticianId" value="<?php echo $dieticianId; ?>" />
...
<tr>
<tr>
<td><font size = 5>Position</font></td>
<td><input type="text" class="demoInputBox" name="position" value="<?php if(isset($_POST['position'])) echo $_POST['position']; ?>"></td>
</tr>
<tr>
...
<tr>
<td colspan="2">
    <input type="submit" name="update_dietician" value="Update Dietician" class="btnRegister"></td>
</td>
</tr>
</table>
</form>
