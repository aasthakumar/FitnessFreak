...
$q=$cn->exec("call prc_add_exercisechart('".$uid."', '".$exerciseName."', '".$duration."','".$caloriesBurned."',@out)");
...
<form name="go_to_show_exercises" method="GET">
	...
	<button class="button button2" formaction="show_exercises.php">Exercises</button>
</body>
