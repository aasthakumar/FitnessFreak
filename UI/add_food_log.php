...
<form name="add_food_log" method="post" action="insert_food_activity.php">
...
<td><select style="width:150" name="mealType" >
...
<td colspan=2>
<input type="submit" name="add_food" value="Add Food" class="btnRegister"></td>
</tr>
</table>
</form>
</body></html>