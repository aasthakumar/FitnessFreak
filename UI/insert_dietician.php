...
$q=$cn->exec("call prc_add_dietician('".$uid."', '".$_POST["firstName"]."', '".$_POST["middleName"]."','".$_POST["lastName"]."', '".$_POST["position"]."','".$_POST["userEmail"]."',@out)");
...
<form name="go_to_show_dietician" method="GET">
