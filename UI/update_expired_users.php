...
$q=$cn->exec("call prc_update_expired_members('".$uid."', @out)");
...
<form name="go_to_show_users" method="GET">
	<input type="hidden" name="uid" value="<?php echo $uid; ?>"/>
	<button class="button button2" formaction="show_users.php">Users</button>
</body>
