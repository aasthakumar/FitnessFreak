...
$uid = $_POST["uid"];
echo $_POST["applicableToTier"];

$q=$cn->exec("call prc_add_offer('".$uid."', '".$_POST["validTill"]."', '".$_POST["applicableToTier"]."','".$_POST["offerDetails"]."',@out)");
...
<form name="go_to_show_offers" method="GET">
	<input type="hidden" name="uid" value="<?php echo $uid; ?>"/>
	<button class="button button2" formaction="show_offers.php">Offers</button>
</body>
